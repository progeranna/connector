...
Run the authorized parallel read-only inventories described in the resumption plan. After their reports are independently reviewed, publish exact implementation contracts for:
